...
cv::Scalar getColorFromId( int id)
{
  ...
  switch(id)
  {
    case 0: retVal = cv::Scalar(128,128,128); break;
    case 1: retVal = cv::Scalar(255,0,0); break;
    case 2: retVal = cv::Scalar(0,255,0); break;
    case 3: retVal = cv::Scalar(0,0,255); break;
    case 4: retVal = cv::Scalar(255,255,0); break;
    case 5: retVal = cv::Scalar(255,0,255); break;
    case 6: retVal = cv::Scalar(0,255,255); break;
    case 7: retVal = cv::Scalar(255,255,255); break;
    default: retVal = cv::Scalar(0,0,0); break;
  };
...
int main(int argc, char **argv)
{
  ...
  cv::namedWindow("object_recognition");
...
//      cv::rectangle(seg,cv::Point(0,0), cv::Point(seg.cols, seg.rows), cv::Scalar(0,0,0), -1);
      ...
      cv::imshow("object_recognition", seg);
  ...
  cv::destroyWindow("object_recognition");
}
